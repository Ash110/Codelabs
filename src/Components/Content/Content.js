        ...
        if (Number(this.props.page) === 1) {
            ...
            MainContent = (
                <Aux>
                    ...
                    <input value={this.state.value} onChange={this.handleChange.bind(this)} id="SubmitBtn"></input><br /><br />
                    <button class="SubmitBtn" style={{borderStyle:"none",boxShadow:"0 2px 2px grey"}} onClick={CheckAnswer}>SUBMIT</button>
                </Aux>
            )
        }
        return (
